    ...
    return (
      <AnimatedPage className="max-w-2xl mx-auto px-4 py-12">
        <div className="mb-8">
          ...
          <h1 className="font-display text-3xl font-800 tracking-tight mt-4 bg-gradient-to-r from-purple-400 via-violet-300 to-fuchsia-400 bg-clip-text text-transparent">
            Guild Management
          </h1>
        ...
        <AnimatedList className="space-y-3 mb-8">
          {[
            ...
            <AnimatedListItem key={feature.title}>
              <div className="card p-4 flex items-start gap-3 hover:border-purple-500/20 transition-all duration-300">
                <div className="w-1.5 h-1.5 rounded-full bg-accent mt-2 flex-shrink-0" style={{ boxShadow: '0 0 6px rgba(124, 58, 237, 0.5)' }} />
                <div>
        ...
        <div className="glass-card-neon p-6 text-center">
          <p className="text-text-secondary text-sm mb-4">
            Sign in with Discord to create or join a guild.
          </p>
          <a href="/api/auth/signin/discord" className="btn-neon text-base px-6 py-3 inline-flex items-center gap-2">
    ...
    <AnimatedPage className="max-w-2xl mx-auto px-4 py-12">
      <ScrollReveal>
        <div className="mb-8">
          ...
          <p className="text-xs font-mono text-accent/60 uppercase tracking-widest mb-1 mt-4">Welcome back</p>
          <h1 className="font-display text-3xl font-800 tracking-tight bg-gradient-to-r from-purple-400 via-violet-300 to-fuchsia-400 bg-clip-text text-transparent">
