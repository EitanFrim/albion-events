...
export default async function SiphonedEnergyPage({ params }: Props) {
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-8 animate-fade-in">
      <div className="mb-6">
        ...
        <p className="text-text-secondary text-sm mt-1">Import and manage siphoned energy transactions.</p>
      </div>
