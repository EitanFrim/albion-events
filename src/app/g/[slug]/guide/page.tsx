          ...
          <div className="space-y-4">
            ...
            <div className="card p-5">
              ...
              <p className="text-text-secondary text-sm leading-relaxed mb-3">
                Click the button below to add the bot to your Discord server. You can also find this in <Link href={`/g/${slug}/settings`} className="text-accent hover:text-accent/80 transition-colors">Guild Settings</Link> → Discord Bot section.
              </p>
              <a
